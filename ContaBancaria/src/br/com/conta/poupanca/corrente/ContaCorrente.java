package br.com.conta.poupanca.corrente;

import br.com.conta.Conta;

/**Sub-Classe concreta tipo ContaCorrente, extendendo a classe Conta.
 * @author José Valdir Gonçalves da Silva Neto
 * @see ContaCorrente
 */
public class ContaCorrente extends Conta{

	public ContaCorrente(int numeroDaConta, float saldo) {
	...
	/**
	 * O metodo retorna os valores de numeroDaConta e saldo formatados
